...
const SYMBOLS = [
  ...
  // ── Index (Yahoo Finance) ──────────────────────────────────────
  { symbol: "^GSPC", source: "yahoo", displayName: "S&P 500",     keywords: ["s&p", "sp500", "s&p500", "snp", "เอสแอนด์พี", "voo"] },
  { symbol: "^NDX",  source: "yahoo", displayName: "NASDAQ 100",  keywords: ["nasdaq", "ndx", "แนสแด็ก", "nasdaq100", "qqq"] },
];
