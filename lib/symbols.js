...
const SYMBOLS = [
  ...
  },
  {
    ...
    tradeNote: "Spot · ผันผวนต่ำ · ไม่เทรด — ดูเทรนด์ & จังหวะซื้อสะสม",
  ...
  // ── Index (Yahoo Finance) — โหมดสะสม/ถือยาว ──────────────────
  {
    ...
    tradeNote: "Index US · ไม่เทรด — ดูจังหวะสะสม/ถือยาวที่ Fib",
    keywords: ["s&p", "sp500", "s&p500", "snp", "เอสแอนด์พี", "voo"],
    mode: "accumulate",
  },
  {
    symbol: "^NDX", source: "yahoo", displayName: "NASDAQ 100",
    tradeNote: "Index US · ไม่เทรด — ดูจังหวะสะสม/ถือยาวที่ Fib (Tech)",
