...
/**
 * @param {string} symbol    e.g. "BTCUSDT"
 * @param {string} interval  Binance interval, e.g. "1d", "1w"
 * @param {number} limit     number of candles (max 1000)
 */
async function fetchKlines(symbol = "BTCUSDT", interval = "1d", limit = 50) {
...
module.exports = { fetchCandles, fetchKlines, fetchPrice };
