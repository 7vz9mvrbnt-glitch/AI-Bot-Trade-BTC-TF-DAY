        ...
        contents: [
          {
            ...
            contents: [
              { type: "text", text: `${setup.displayName || setup.symbol} · Daily`, color: "#FFFFFF", size: "sm", flex: 1 },
              ...(setup.signalScore ? [
          ...
          ...(setup.signalScore ? [
            { type: "text", text: `สัญญาณ: ${setup.signalScore.label}`, color: "#fde68a", size: "xxs", margin: "xs" },
          ] : []),
      ...
      body: {
        ...
        contents: [
          row("ราคา", `$${setup.price.toLocaleString()}`),
          {
            ...
            contents: [
              { type: "text", text: "Trend", size: "sm", color: "#555555", flex: 2 },
              {
                ...
                contents: [
                  { type: "text", text: setup.trend, size: "sm", color: setup.trend === "UP" ? "#16a34a" : "#dc2626", weight: "bold", flex: 1 },
                  {
                    type: "text",
                    text: setup.weeklyTrend ? `W:${setup.weeklyTrend}` : "W:--",
                    size: "xxs",
                    color: !setup.weeklyTrend ? "#9ca3af"
          ...
          ...(setup.rsi ? [{
            ...
            contents: [
              { type: "text", text: "📊 ความร้อนแรง", size: "sm", color: "#555555", flex: 2 },
              { type: "text", text: `${setup.rsi.emoji} ${setup.rsi.label}`, size: "sm", flex: 3, align: "end", color: setup.rsi.color, weight: "bold" },
            ],
          }] : []),
          ...(setup.macd ? [{
            type: "box", layout: "horizontal", margin: "sm",
            contents: [
              { type: "text", text: "⚡ แรงขับเคลื่อน", size: "sm", color: "#555555", flex: 2 },
              { type: "text", text: `${setup.macd.emoji} ${setup.macd.label}`, size: "sm", flex: 3, align: "end", color: setup.macd.cross === "bullish" ? "#16a34a" : setup.macd.cross === "bearish" ? "#dc2626" : "#555555" },
            ],
          }] : []),
          ...(setup.fibZone ? [
            {
