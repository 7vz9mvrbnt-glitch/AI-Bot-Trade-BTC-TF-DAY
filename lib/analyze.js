...
function calcMACD(closes) {
  ...
  const signalArr = emaArray(macdArr.slice(ema26arr.findIndex((v) => v > 0)), 9);
...
module.exports = { analyze, toSheetRow, ema, buildAIComment, getMarketStatus, calcRSI, calcMACD };
